  ...
  (define-syntax-rule (comment-frame new-class base-class)
    (define-binary-class new-class base-class
      ((encoding u1)
       ...
       (description (id3-encoded-string encoding #:terminator #\nul))
  ...
  (define *id3-v1-genres*
    #(
      ...
      "Blues" "Classic Rock" "Country" "Dance" "Disco" "Funk" "Grunge"
              ...
              "Synthpop")))
(require 'unsafe racket/contract racket/class)
(provide (contract-out [read-id3 (-> path-string? any)]
                       [song (-> (is-a?/c id3-tag%) any)]
                       [album (-> (is-a?/c id3-tag%) any)]
                       [artist (-> (is-a?/c id3-tag%) any)]
                       [track (-> (is-a?/c id3-tag%) any)]
                       [year (-> (is-a?/c id3-tag%) any)]
                       [genre (-> (is-a?/c id3-tag%) any)]
                       [translated-genre (-> (is-a?/c id3-tag%) any)])
         id3v2.2-tag%
         id3v2.3-tag%
         generic-frame-v2.2%
         generic-frame-v2.3%
...
(module* safe #f
  ...
  (define-syntax-rule (id3-tag/c CLASS BODY ...)
    (binary-class/c CLASS 
                    BODY ...            
                    (field [identifier (or/c #f "ID3")]
                           [major-version (or/c #f 2 3)]
                           [revision u1?]
                           [flags u1?]
                           [size u1?])))
  (define-syntax-rule (id3v2.2-frame/c CLASS BODY ...)
    (binary-class/c CLASS 
                    BODY ...            
                    (field [id (iso-8859-1-len/c 4)]
                           [size u3?])))
  (define-syntax-rule (id3v2.3-frame/c CLASS BODY ...)
    (binary-class/c CLASS 
                    BODY ...            
                    (field [id (iso-8859-1-len/c 5)]
                           [size u4?]
                           [flags u2?]
                           [decompressed-size u4?]
                           [encryption-scheme u1?]
  ...
  (provide/contract 
   ...
   [id3v2.3-tag% (id3-tag/c id3v2.3-tag% 
                            (field [frames (listof (is-a?/c id3v2.3-frame%))]
                                   [extended-header-size u4?]
                                   [extra-flags u2?]
                                   [padding-size u4?]
                                   [crc u4?]))]
   [generic-frame-v2.2% (id3v2.2-frame/c generic-frame-v2.2%
                                         (field [data (or/c #f bytes?)]))]
   [generic-frame-v2.3% (id3v2.3-frame/c generic-frame-v2.2%
                                         (field [data (or/c #f bytes?)]))]
   [text-info-frame-v2.2% (id3v2.2-frame/c generic-frame-v2.2%
                                         (field [encoding u1?]
                                                [information (or/c #f string?)]))]
   [text-info-frame-v2.3% (id3v2.2-frame/c generic-frame-v2.3%
                                         (field [encoding u1?]
                                                [information (or/c #f string?)]))]
   [comment-frame-v2.2% (id3v2.2-frame/c generic-frame-v2.3%
                                         (field [encoding u1?]
                                                [language (iso-8859-1-len/c 4)]
                                                [description (string-terminated/c #\nul)]
                                                [text (or/c #f string?)]))]
   [comment-frame-v2.3% (id3v2.3-frame/c generic-frame-v2.3%
                                         (field [encoding u1?]
                                                [language (iso-8859-1-len/c 4)]
                                                [description (string-terminated/c #\nul)]
                                                [text (or/c #f string?)]))]))